...
interface AdminState {
  ...
  setOptionGroups: (productId: string, groups: OptionGroupWithOptions[]) => void;
  ...
  removeProductionCenter: (id: string) => void;
  upsertOptionGroup: (productId: string, group: OptionGroupWithOptions) => void;
  removeOptionGroup: (productId: string, groupId: string) => void;
  upsertOption: (productId: string, groupId: string, option: Option) => void;
  removeOption: (productId: string, groupId: string, optionId: string) => void;
