...
export function AvailableDatesEditor({ anchorRef, dates, onChange, onClose }: {
    ...
    <Popover anchorRef={anchorRef} onClose={onClose} width={260}>
      <div style={{ padding: "var(--sp-md)" }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "8px" }}>
          <IconButton variant="plain" aria-label="Mese precedente" onClick={() => changeMonth(-1)}>
          ...
          <IconButton variant="plain" aria-label="Mese successivo" onClick={() => changeMonth(1)}>
